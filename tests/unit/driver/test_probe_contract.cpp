...
TEST(VirtualDisplayProbeContract, PlansProbeCommandArgcBoundsAndExecutionStage) {
  ...
  constexpr std::array kPlans {
    ...
    ExpectedPlan {"--probe-idd-hdr-functionalize-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-idd-hdr-functionalize-shared-owner-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-idd-hdr-functionalize-nongdi-source-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-wcg-prime-hdr-inherited-token", 6, 6, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-wcg-prime-hdr-native-user", 5, 5, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--remote-current-session-wcg-to-hdr", 4, 4, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--query-private-functionalize-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--launch-displaymanager-owner2-probe-in-session", 4, 4, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-displaymanager-acquire-arriving-target", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-displaymanager-fp16-functionalize-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-displaymanager-desktop-hdr-functionalize-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-displaymanager-desktop-owner2-hdr-functionalize-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-displaymanager-fp16-enforce-functionalize-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--dump-display-config-current-session", 2, 2, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--query-vidpn-ownership-current-session", 2, 3, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--query-hdr-target", 4, 4, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--query-d3dkmt-current-mode", 4, 4, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--query-d3dkmt-mode-list", 4, 4, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--set-hdr-target", 5, 5, vdd::ProbeCommandExecutionStage::NoControlDevice},
    ExpectedPlan {"--probe-idd-hdr-gate", 4, 4, vdd::ProbeCommandExecutionStage::NoControlDevice},
